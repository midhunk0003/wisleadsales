...
class LeadManagmentRepositoryImpli extends LeadManagmentRepository {
  ...
  Future<Either<Failure, List<CallLanguage>?>> getLeadCallLAnguage(
    ...
    try {
      ...
      log("get lead call language listxxxxxxxxxxxxxxx  : ${response.body}");
      ...
      if (response.statusCode == 200) {
        ...
        // Convert JSON into LeadManagementModel
        // final leadModel = LeadManagmentModel.fromJson(leadStatusList);
        print('get lead call language  list inside : ${leadLanguage}');
  ...
  @override
  Future<Either<Failure, List<CallNote>?>> getLeadCallNote(
    String? token,
  ) async {
    final client = http.Client();
    ...
    try {
      ...
      log("get lead call note listxxxxxxxxxxxxxxx  : ${response.body}");
      ...
      if (response.statusCode == 200) {
        ...
        // Convert JSON into LeadManagementModel
        // final leadModel = LeadManagmentModel.fromJson(leadStatusList);
        print('get lead call note  list inside : ${leadCallNote}');
