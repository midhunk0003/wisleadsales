...
//       await provider.getProfileData(); // wait for data to load
//       provider.clearSelectedImages();
//       final prefs = await SharedPreferences.getInstance();
//       final profile = provider.profileDatas;
//       if (profile == null) return; // safety guard
//       prefs.setString('profileImage', profile.profileImage ?? '');
//       print('aaaaaaaaa : ${provider.profileDatas!.name ?? ''}');
//       print('aaaaaaaaaxxx... : ${provider.profileDatas!.docVerified ?? ''}');
//       nameController.text = provider.profileDatas!.name ?? '';
//       contactController.text = provider.profileDatas!.mobilePhone ?? '';
//       emailController.text = provider.profileDatas!.email ?? '';
//       employeIdController.text = provider.profileDatas!.empId ?? '';
//       designationController.text = provider.profileDatas!.designation ?? '';
//       regionController.text = provider.profileDatas!.branch ?? '';
//       resumeController.text = getFileName(provider.profileDatas?.resume);
//       addressDocController.text = getFileName(
//         provider.profileDatas?.addressProof,
//       );
//       accountNumberController.text =
//           provider.profileDatas!.bankDetails!.accountNo ?? '';
//       accountNameController.text =
//           provider.profileDatas!.bankDetails!.bankName ?? '';
//       ifscCOdeController.text =
//           provider.profileDatas!.bankDetails!.ifscCode ?? '';
//       designationController.text = provider.profileDatas!.designation! ?? '';
//       regionController.text = provider.profileDatas!.branch! ?? '';
//     });
//   }

//   void showSelectedDataInFormField() {
//     final provider = Provider.of<ProfileProvider>(context, listen: false);
//     WidgetsBinding.instance.addPostFrameCallback((_) async {
